...
/*   FLASH_AB    : origin = 0x3F4000, length = 0x003F80     /* 16Kw on-chip FLASH */
   FLASH_B     : origin = 0x3F4000, length = 0x001F80     /* 8Kw on-chip FLASH */
...
/*   PASSWORDS   : origin = 0x3F7FF8, length = 0x000008     /* Part of FLASHA.  CSM password locations. */
   ...
   CSM_RSVD    : origin = 0x3F5F80, length = 0x000076     /* Part of FLASHB.  Reserved when CSM is in use. */
   BEGIN_FLASH : origin = 0x3F5FF6, length = 0x000002     /* Part of FLASHB.  Used for "boot to flash" bootloader mode. */
   PASSWORDS   : origin = 0x3F5FF8, length = 0x000008     /* Part of FLASHB.  CSM password locations. */
...
/*** User Defined Sections ***/
   ...
   secureRamFuncs    :   LOAD = FLASH_B,                          /* Used by flash_init() in system.c and others */
                         RUN = L0SARAM,     
