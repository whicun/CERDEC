...
void mailboxTX(long dataH, long dataL, int mailboxBit) {
	switch(mailboxBit) {
		...
		break;
		case 10:
			ECanaMboxes.MBOX10.MDL.all = dataL;
			ECanaMboxes.MBOX10.MDH.all = dataH;

		break;
		case 11:
			ECanaMboxes.MBOX11.MDL.all = dataL;
			ECanaMboxes.MBOX11.MDH.all = dataH;

		break;
		case 12:
			ECanaMboxes.MBOX12.MDL.all = dataL;
			ECanaMboxes.MBOX12.MDH.all = dataH;

		break;
		case 13:
			ECanaMboxes.MBOX13.MDL.all = dataL;
			ECanaMboxes.MBOX13.MDH.all = dataH;
...
//    ECanaShadow.CANBTC.bit.BRPREG = 9;				// 1 Mbps @ 150 MHz SYSCLKOUT
    ECanaShadow.CANBTC.bit.BRPREG = 19;				// 0.5 Mbps @ 150 MHz SYSCLKOUT
...
void configCAN() {
	...
	ECanaMboxes.MBOX0.MSGID.bit.STDMSGID   = 0x420;		// User CMD (out)
	ECanaMboxes.MBOX1.MSGID.bit.STDMSGID   = 0x430;		// Conv_stat (in)
	ECanaMboxes.MBOX2.MSGID.bit.STDMSGID   = 0x431;		// conv_data1 (in)
	ECanaMboxes.MBOX3.MSGID.bit.STDMSGID   = 0x432;		// conv_data2 (in)
	ECanaMboxes.MBOX4.MSGID.bit.STDMSGID   = 0x433;		// conv_data3 (in)
	ECanaMboxes.MBOX5.MSGID.bit.STDMSGID   = 0x434;		// conv_data4 (in)
	ECanaMboxes.MBOX6.MSGID.bit.STDMSGID   = 0x435;		// conv_temp1 (in)
	ECanaMboxes.MBOX7.MSGID.bit.STDMSGID   = 0x436;		// conv_temp2 (in)

	ECanaMboxes.MBOX10.MSGID.bit.STDMSGID   = 0x400;		// bms_stat (out)
	ECanaMboxes.MBOX11.MSGID.bit.STDMSGID   = 0x401;		// bms_data1 (out)
	ECanaMboxes.MBOX12.MSGID.bit.STDMSGID   = 0x402;		// bms_data2 (out)
	ECanaMboxes.MBOX13.MSGID.bit.STDMSGID   = 0x403;		// bms_data3 (out)
	ECanaMboxes.MBOX14.MSGID.bit.STDMSGID   = 0x410;		// bms_cmd (in)
	...
	ECanaShadow.CANME.bit.ME14 = 1;	// enable mailbox 14
	ECanaShadow.CANME.bit.ME13 = 1;	// enable mailbox 13
